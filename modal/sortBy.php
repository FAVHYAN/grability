...
<div class="contentHero">
			...
			<div class="col-md-12"><span class="subTitleHero">Related commics</span></div>
				<div class="col-md-6">
				<a data-toggle="modal" data-id="<?php echo $comic[1] ?>" title="Add this item" class="open-AddBookDialog-search" href="#modalHeroSearch">
					<?php echo $obj->data->results[$i]->comics->items[0]->name ?>
					</a>
				</div>
				<div class="col-md-6">
				<a data-toggle="modal" data-id="<?php echo $comicDos[1] ?>" title="Add this item" class="open-AddBookDialog-search" href="#modalHeroSearch">
					<?php echo $obj->data->results[$i]->comics->items[1]->name ?>
					</a>
				</div>
				<div class="col-md-6">
				<a data-toggle="modal" data-id="<?php echo $comicTres[1] ?>" title="Add this item" class="open-AddBookDialog-search" href="#modalHeroSearch">
					<?php echo $obj->data->results[$i]->comics->items[2]->name ?>
					</a>
				</div>
				<div class="col-md-6">
				<a data-toggle="modal" data-id="<?php echo $comicCuatro[1] ?>" title="Add this item" class="open-AddBookDialog-search" href="#modalHeroSearch">
